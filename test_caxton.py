...
CHECKPOINT_MODEL_PATH = './output/model/microsoft/resnet-50-3dprint_caxton-1e-05-100-epoch=20-val_f1=0.9999_80_train_20_val.ckpt'
...
def main():
    ...
    results_df.to_csv(SAVING_OUTPUTS+f'results_{saving_name}_caxton_train_80_val_20.csv', index=False)
